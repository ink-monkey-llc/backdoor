...
import { makeEventDates } from '../../../lib/date-utils'
import { createEvent, callUpdateEvent } from '../../../resource/events'
...
function Submit() {
    ...
    const handleSubmit = () => {
        if (!allDay && (!startTime || !endTime)) {
            alert('Please select a start and end time, or select all day')
            return
        }
